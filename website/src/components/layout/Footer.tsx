...
const Footer: React.FC = () => {
  ...
  const footerLinks = {
    ...
    careers: [
      { label: '招聘岗位', href: '/careers' },
      { label: '工作环境', href: '/careers#culture' },
      { label: '福利待遇', href: '/careers#benefits' },
    ],
    legal: [
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-sm text-tertiary leading-relaxed">
              专注AI Agent的创新科技公司，致力于打造下一代智能应用平台。
            </p>
          </div>

          {/* Product Links */}
          <div>
            <h3 className="font-semibold text-primary mb-4">公司</h3>
          ...
          {/* Careers Links */}
          <div>
            <h3 className="font-semibold text-secondary mb-4">招聘</h3>
            <ul className="space-y-2">
          ...
          {/* Legal Links */}
          <div>
            <h3 className="font-semibold text-primary mb-4">法律</h3>
            <ul className="space-y-2">
